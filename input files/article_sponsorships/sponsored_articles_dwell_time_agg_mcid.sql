...
BEGIN;
DELETE FROM &{pipeline_schema_sf}.sponsored_articles_dwell_time_agg_mcid
WHERE ds BETWEEN '&{start_dt}' and '&{end_dt}';
;

INSERT INTO &{pipeline_schema_sf}.sponsored_articles_dwell_time_agg_mcid
with    op1_details as (
...
pio as  (
     ...
     articles_dwell_time as (
         ...
         from &{pipeline_schema_sf}.sponsored_articles_dwell_time_unique_mcid dt
...
group by a.ds, a.url_id, op.op_advertiser_id, op.advertiser_name, a.order_id, op.sales_order_name, op.industry, op.region, op.account_exec, a.article_title,
         a.sponsor_name, a.use_sponsor_info, a.utm_source, a.marketing_campaign_id, a.locale, a.user_country_name, platform, sponsor_status
;
