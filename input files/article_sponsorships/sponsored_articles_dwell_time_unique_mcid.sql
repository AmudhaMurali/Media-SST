BEGIN;;
delete from &{pipeline_schema_sf}.sponsored_articles_dwell_time_unique_mcid
where ds between '&{start_dt}' and '&{end_dt}';
;

insert into &{pipeline_schema_sf}.sponsored_articles_dwell_time_unique_mcid
...
JOIN (select distinct j.unique_id, j.uid, j.url, j.user_country_name, j.os_type_name, j.ds, j.marketing_campaign_id
