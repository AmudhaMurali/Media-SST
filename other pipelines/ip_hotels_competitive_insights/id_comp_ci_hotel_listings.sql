...
delete from &{pipeline_schema}.id_comp_ci_hotel_listings
where ds between '&{start_dt}' and '&{end_dt}';

insert into &{pipeline_schema}.id_comp_ci_hotel_listings
...
group by cb.ds, cm.rank, cm.brand, cm.brand_code, cm.parent_brand, cm.comp_for_country, cm.comp_brand_code, cb.star_rating
