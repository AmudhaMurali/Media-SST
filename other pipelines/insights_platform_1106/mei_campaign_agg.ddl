CREATE TABLE IF NOT EXISTS &{pipeline_schema}.mei_campaign_agg (
    DS                                  DATE    ,
    OS_TYPE                             STRING  ,
    OS_GROUP                            STRING  ,
    LOCALE                              STRING  ,
...
GRANT OWNERSHIP ON TABLE &{pipeline_schema}.mei_campaign_agg TO ROLE cx_analytics_role REVOKE CURRENT GRANTS;
GRANT SELECT ON &{pipeline_schema}.mei_campaign_agg TO PUBLIC;