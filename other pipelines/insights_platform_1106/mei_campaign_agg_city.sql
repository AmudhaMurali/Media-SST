...
delete from &{pipeline_schema}.mei_campaign_agg_city
where ds between '&{start_dt}' and '&{end_dt}';

insert into &{pipeline_schema}.mei_campaign_agg_city
WITH impressions as (
...
FROM interactions inter
    ...
    LEFT JOIN (select distinct GEO_ID, PLACE_TYPE from rio_sf.hotels_sst.a_geo_details_daily) c on c.geo_id = reg.geo_id
